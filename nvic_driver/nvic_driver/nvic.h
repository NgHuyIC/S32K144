/**
 * @file    nvic.h
 * @brief   NVIC Function Definitions
 * @details This file contains function prototypes and definitions related to NVIC (Nested Vectored Interrupt Controller).
 */
 ...
 * @param   priority: The priority value to set (0-15)
 * @return  void
 */
